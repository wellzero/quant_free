...
def file_path(file_name, cache_type=CACHE_TYPE.default, file_type = __file_type__):
    # print(__cache_dir__ + cache_type.value + file_name + __file_type__)
    return __cache_dir__ + cache_type.value + file_name + file_type
...
def save_csv(name, data, cache_type=CACHE_TYPE.default, file_type = '.csv'):
    data.to_csv(file_path(name,cache_type=cache_type, file_type = file_type))
